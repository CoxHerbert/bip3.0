...
const isMobileView = ref(false); // 是否为 H5 视图
...
const cardBodyStyle = computed(() => ({
  overflowY: isMobileView.value ? 'visible' : 'auto',
  paddingTop: '12px',
  paddingInline: isMobileView.value ? '12px' : undefined,
}));

const tabPaneClass = computed(() => [
  'tab-pane-content',
  { 'tab-pane-mobile': isMobileView.value },
]);
      ...
      <div class="flex h-full flex-col">
        ...
        <div class="flex flex-col gap-2">
          ...
          <component
            ...
            class="audit-icon absolute right-5 top-2.5 size-36"
          />
        </div>
        ...
        <div class="process-tabs-container flex flex-1 flex-col">
          <Tabs
            ...
            class="mt-0 h-full"
            :tab-bar-gutter="isMobileView ? 8 : undefined"
          >
            <TabPane tab="审批详情" key="form" :class="tabPaneClass">
            ...
            <TabPane tab="流转记录" key="record" :class="tabPaneClass">
              <div class="h-full">
