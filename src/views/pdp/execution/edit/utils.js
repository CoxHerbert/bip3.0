  ...
  columns: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          required: true,
          props: {
            action: Api.pdp.execution.endCustomers,
        ...
        },
        {
          ...
          showFunc(detailData) {
            return (
              detailData.causeOfRejection &&
              ['1876789881673412609', '1876789924404981761', '1876789752111362049'].includes(
                detailData?.dcErpOrderStatus
              )
            );
          },
      ...
      items: [
        ...
        },
        {
          ...
          props: {
            labelKey: 'fname',
            valueKey: 'fname',
            action: Api.pdp.execution.getCostProject,
          },
        },
        {
