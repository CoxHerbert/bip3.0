          ...
          >
            <template v-if="roleName && roleName.length > 0" #menu-left>
              ...
              <el-button
                ...
                v-permission="{ id: 'user_platform_config' }"
              ...
              <el-button
                ...
                v-permission="{ id: 'user_account_unblocking' }"
                @click="handleLock"
                >账号解封
              </el-button>
              <el-button
              ...
              <el-button
                type="warning"
                plain
                v-if="permission.DC_WECHATREG && !auditMode"
                icon="el-icon-plus"
                v-permission="{ id: 'DC_WECHATREG' }"
                @click="headleWxReg"
                >企业微信
              </el-button>
            </template>
            ...
            <template #option="{ row }">
              <el-button
                type="text"
                v-permission="{ id: 'user_view', row: row }"
                @click="doAction('view', row)"
                icon="view"
                >查看</el-button
              >
              <el-button
              ...
              <el-button
                type="text"
                @click="doAction('delete', row)"
                v-permission="{ id: 'user_delete', row: row }"
                icon="delete"
                >删除</el-button
              >
            </template>
...
export default {
  ...
  methods: {
    headleWxReg() {
      ...
      this.$confirm('确定加入企业微信?', {
        confirmButtonText: '确定',
        cancelButtonText: '取消',
        type: 'warning',
      })
        .then(() => {
          return wechatCreate(this.ids);
        })
        .then(() => {
